...
public class LichSu implements Serializable {
    ...
    public LichSu(JSONObject o) throws JSONException {
        id = o.getString("id");
    ...
    public LichSu(String id, String tenTruyen, String anh, String nguon, String tacGia, String theLoai, String soChap, String ngay, String luotXem, Date thoiGian) {
        this.id = id;
